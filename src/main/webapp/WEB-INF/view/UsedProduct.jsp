			  ...
			  <c:forEach var="item" items="${Items}">
		          <div class="col-lg-4 col-md-5 mb-4">
		            <div class="card h-100">
		              <a href="<c:url value="viewProduct"><c:param name='itemId' value='${item.itemId}'/></c:url>"><img class="card-img-top" src="http://placehold.it/700x400" alt="<c:url value='/upload/${item.imgName}' />"></a>
		              <div class="card-body">
		                <h4 class="card-title">
